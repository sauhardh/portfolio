...
export default function SayMyName() {
    return (
        <div className="relative text-primary flex max-w-screen flex-col justify-center font-alfa text-center overflow-hidden border-white mt-3 p-0 h-max">
            <span className="block w-full text-9xl transform scale-x-[1.45] origin-center">SAUHARDHA</span>
            <span className="block w-full text-9xl transform scale-x-[2.8] origin-center">KAFLE</span>
